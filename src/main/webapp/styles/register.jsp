...
<div class="page-container">
    ...
    <form action="<%= request.getContextPath() %>/RegistrationServlet" method="post">
        ...
        <table cellspacing=0 cellpadding="10">
            ...
            <tr>
                <td align="left" style="color: black"><b>Aadhaar Number:</b></td>
                <td>
                    <input type="text" id="aadhaar" name="aadhaar" size="30" maxlength="12" 
                           pattern="\d{12}" title="Enter a valid 12-digit Aadhaar number">
                </td>
            </tr>
            <tr>
                <td></td>
