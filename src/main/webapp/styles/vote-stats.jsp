...
<%@page import="com.database.VotingBin" %>
...
<body>
	<div id="page">
		<div id="header">
			...
			Vote counts = vb.getVoteCounts();

			int javaCount = counts.getJavaCount();
			int dotnetCount = counts.getDotnetCount();
			int pythonCount = counts.getPythonCount();
